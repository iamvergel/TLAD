      ...
      $.ajax({
        ...
        success: function (response) {
          try {
            ...
            unitSelect1.empty();
            unitSelect1.append('<option value="" selected disabled>Select Unit</option>');
        ...
        error: function (xhr, status, error) {
          console.error('AJAX request failed:', error);
          alert('An error occurred while fetching the units.');
          $('#unitSection').html('<option value="" disabled selected>Select Unit</option>');
        }
      });
    } else {
      $('#unitSection').html('<option value="" disabled selected>Select Unit</option>');
    ...
    if (unitId) {
      ...
      $.ajax({
        ...
        error: function (xhr, status, error) {
          console.error('AJAX request failed:', error);
          alert('An error occurred while fetching the coordinators.');
          $('#coordinator_id').html('<option value="" disabled selected>Select Coordinator</option>');
        }
      });
    } else {
      $('#coordinator_id').html('<option value="" disabled selected>Select Coordinator</option>');
    ...
    if (departmentId1) {
      ...
      $.ajax({
        ...
        error: function (xhr, status, error) {
          console.error('AJAX request failed:', error);
          alert('An error occurred while fetching the units.');
          $('#edit_unitSection').html('<option value="" selected disabled>Select Unit</option>');
        }
      });
    } else {
      $('#edit_unitSection').html('<option value="" selected disabled>Select Unit</option>');
