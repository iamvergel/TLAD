                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Article Title</label><span class="text-danger">*</span>
                                        <input type="text" name="art_title" id="edit_art-title" class="form-control"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    ...
                                    <table id="example1" class="table table-borderless table-hover" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($query_run)) {
                                                ?>
                                                <tr>
                                                    <td><img src="../../../upload/service/<?= $row['image'] ?>"
                                                            class="img-fluid img-thumbnail" width="100" alt=""></td>
                                                    <td><?= $row['title'] ?></td>
                                                    <td><?= $row['description'] ?></td>
                                                    <td>
                                                        <button data-id="<?= $row['id'] ?>"
                                                            class="btn btn-sm btn-info editServicebtn"><i
                                                                class="fas fa-edit"></i></button>
                                                        <input type="hidden" name="del_image" value="<?= $row['image']; ?>">
                                                        <button data-id="<?= $row['id'] ?>"
                                                            class="btn btn-danger btn-sm deleteServicebtn"><i
