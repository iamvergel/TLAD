              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    <select class="form-control select2 dentist" name="select_dentist" id="edit_dentist"
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="col-md-12 mt-4">
                  <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="pending-tab" data-toggle="tab" data-target="#pending" role="tab"
