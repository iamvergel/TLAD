                    ...
                    <div class="col-md-12">
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <h3 class="card-title" id="EmployeeNumberTitle">Coordinator Information</h3>
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        foreach ($query_run as $row) {
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="d-flex justify-content-center align-items-center mt-3">
                                                        <img src="../../../upload/coordinators/<?= $row['image'] ?>" alt="coor avatar" class="img-thumbnail img-circle" width="200" height="200">
                                                    </div>
                                                    ...
                                                    <p class="text-muted text-center mb-5 mt-0">
                                                        <?php echo $row['email'] ?>
                                                    </p>
                                                    <ul class="list-group list-group-unbordered mb-2 px-3">
                                                        <li class="list-group-item">
                                                            <b class="float-left">Role</b>
                                                            <p class="float-right text-muted"><?php echo $row['role']; ?></p>
                                                        </li>
                                                        <li class="list-group-item">
                                                        ...
                                                        <li class="list-group-item">
                                                            <b class="float-left">Department Head</b>
                                                            <p class="float-right text-muted">
                                                                <?php echo $row['division_head_name']; ?>
                                                            </p>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b class="float-left">Department Head Position</b>
                                                            <p class="float-right text-muted">
                                                                <?php echo $row['division_head_position']; ?>
                                                            </p>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b class="float-left">Unit Section Head</b>
                                                            <p class="float-right text-muted">
                                                                <?php echo $row['unit_section_head_name']; ?>
                                                            </p>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <b class="float-left">Unit Section Head Position</b>
                                                            <p class="float-right text-muted">
                                                                <?php echo $row['unit_section_head_title']; ?>
                                                            </p>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header p-2">
                                                            <ul class="nav nav-pills" id="custom-tabs-three-tab" role="tablist">
                                                                <li class="nav-item">
                                                                    <a class="nav-link active" href="dashboard-tab"
                                                                        data-toggle="tab" data-target="#dashboard" role="tab"
                                                                        aria-controls="dashboard" aria-selected="true">Dashboard</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="employees-teb" data-toggle="tab"
                                                                        data-target="#employees" role="tab"
                                                                        aria-controls="employees"
                                                                        aria-selected="false"><?php echo $row['department_name'] . ' / ' . $row['unit_name']; ?></a>
                                                                </li>
                                                                <!-- <li class="nav-item">
                                                                    <a class="nav-link" href="gallery-tab" data-toggle="tab"
                                                                        data-target="#gallery" role="tab" aria-controls="gallery"
                                                                        aria-selected="false">Report Submitted</a>
                                                                </li> -->
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="card-body p-3">
                                                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-6 col-12 mt-5">
                                                                                    <div class="small-box bg-light">
                                                                                        <div class="inner">
                                                                                            <canvas id="trainingChart" width="400"
                                                                                                height="400"></canvas>
                                                                                        </div>
                                                                                        <div class="icon">
                                                                                    ...
                                                                                    <div class="row">
                                                                                            ...
                                                                                            <div class="small-box bg-success p-3">
                                                                                                <div class="inner">
                                                                                                    <h4 style="font-weight: bold">
                                                                                                        With Training Percentage:
                                                                                                        <br /> <br /> <span
                                                                                                            id="withTrainingPercent"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div class="small-box bg-danger p-3">
                                                                                                <div class="inner">
                                                                                                    <h4 style="font-weight: bold">
                                                                                                        Without Training Percentage:
                                                                                                        <br /> <br /> <span
                                                                                                            id="withoutTrainingPercent"
                                                                                                            style="font-weight: normal">0%</span>
                                                                                                    </h4>
                                                                                                </div>
                                                                                                <div class="icon">
                                                                ...
                                                                <div class="tab-pane fade" id="employees" role="tabpanel"
                                                                    aria-labelledby="employees-teb">
                                                                    <div class="card-body">
                                                                        <table id="employee_table"
                                                                            class="table table-borderless table-hover overflow-x-auto"
                                                                            width="100%">
                                                                    ...
                                                                    <div class="container-fluid"
                                                                        ...
                                                                        <div class="row no-gutters">
                                                                            ...
                                                                            if (isset($_GET['EmployeeNumber'])) {
                                                                                ...
                                                                                if ($check_services) {
                                                                                    while ($row = mysqli_fetch_array($query_run)) {
                                                                                        $fileExtension = pathinfo($row['dashboardImage'], PATHINFO_EXTENSION);
                                                                                        $filePath = "../../../upload/dashboards/" . $row['dashboardImage'];
                                                                                        $title = $row['Title'];
                                                                                        $maxTitleLength = 30;
                                                                                                ...
                                                                                                <div class="card-body">
                                                                                                    ...
                                                                                                    if (in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png'])) {
                                                                                                        echo "<a href='$filePath' class='gallery-lightbox'>
                                                                                                                <img src='$filePath' alt='dashboard' class='card-img-top'>
                                                                                                            </a>";
                                                                                                    } elseif (strtolower($fileExtension) == 'pdf') {
                                                                                                        echo "<a href='$filePath' class='btn btn-primary w-100 gallery-lightbox' target='_blank'>
                                                                                                                    <i class='far fa-file-pdf me-3'></i> View dashboard
                                                                                                                </a>";
                                                                                                    }
                                                                                                    ?>
                                                                                                </div>
                                                                                    ...
                                                                                    echo "<p>No dashboards found for this user.</>";
                                                                                }
                                                                            }
                                                                            ?>
                                                                        </div>
                                            ...
                                            <script>
                                                ...
                                                function showdashboard(imageSrc) {
                                                    window.open("../../upload/dashboards/" + imageSrc);
                                                }
                                            </script>
                                            <?php
                                        }
