              ...
              <div class="row">
                <!-- <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select class="form-control select2 patient" name="select_patient" id="selectedPatient"
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    <input class="form-control" name="patient_name" id="selectedPatient" required>
                  </div>
                </div>
                <div class="form-group col-md-12">
                  <label>Address</label><span class="text-danger">*</span>
                  <input type="text" class="form-control address" name="address" id="Address" style="width: 100%;"
                    value="" required>
                </div>
                <div class="form-group col-md-6">
                  <label>Phone</label><span class="text-danger">*</span>
                  <input type="text" class="form-control phone" name="phone" id="Phone" style="width: 100%;" value=""
                    required>
                </div>
                <div class="form-group col-md-6">
                  <label>Age</label><span class="text-danger">*</span>
                  <input type="text" class="form-control dob" name="dob" id="dob" style="width: 100%;" value=""
                    required>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control personal_status" name="personal_status" id="personal_status"
                    style="width: 100%;" required>
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control complain" name="complain" id="complain" rows="5"
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    <select class="form-control select2 dentist" name="select_dentist" id="preferredDentist"
                      style="width: 100%;" required>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    <input type="date" class="form-control" name="scheddate" id="currentDate" style="width: 100%;"
                      required><!--select2 -->
                  </div>
                </div>
                <!-- <div class="col-sm-12">
                  <div class="form-group">
                    <label>Appontment Date</label>
                    <span class="text-danger">*</span>
                    <select class="form-control select2" name="scheddate" id="preferredDate" style="width: 100%;"
                      required>
                    </select>
                  </div>
                </div> -->
                <!-- <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    <select class="form-control select2" name="schedTime" id="preferredTime" style="width:100%;"
                      required>
                    </select>
                  </div>
                </div> -->
                <div class="form-group col-md-6">
                  ...
                  <input type="time" class="form-control" name="start_time" id="start_time" style="width: 100%;"
                    value="" required>
                </div>

                <div class="form-group col-md-6">
                  <label for="end_time">End Time</label><span class="text-danger">*</span>
                  <input type="time" class="form-control" name="end_time" id="end_time" style="width: 100%;" value=""
                    required>
                </div>
                ...
                <div class="form-group col-md-12">
                  <label for="payment">Payment</label><span class="text-danger">*</span>
                  <input type="number" class="form-control" name="payment" id="payment" style="width: 100%;" value=""
                    required>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <label>Select Patient</label>
                    <span class="text-danger">*</span>
                    <input type="text" id="edit_patient" readonly>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Select Doctor</label>
                    <span class="text-danger">*</span>
                    <select class="form-control select2 dentist" name="" id="edit_dentist" style="width:100%;" required
                      disabled>
                      <?php
                      if (isset($_GET['id'])) {
                        echo $id = $_GET['id'];
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>Appontment Time</label>
                    <span class="text-danger">*</span>
                    <select class="form-control select2" name="schedTime" id="edit_schedTime" style="width:100%;"
                      required>
                    </select>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>Service</label>
                    <span class="text-danger">*</span>
                    <select class="select2" multiple="multiple" name="service[]" id="edit_reason" style="width: 100%;"
                      required>
                      <?php
                      $sql = "SELECT * FROM procedures ORDER BY procedures ASC";
                      $query_run = mysqli_query($conn, $sql);
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>Appointment Status</label>
                    <span class="text-danger">*</span>
                    <select class="form-control custom-select" name="status" id="edit_status" id="show-checkbox"
                      required>
                      <option value="Confirmed">Confirmed</option>
                ...
                <div class="col-sm-12">
                  <div class="custom-control custom-checkbox" id="show-email2">
                    <input class="custom-control-input ck" type="checkbox" id="customCheckbox3" name="send-email"
                      disabled>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <label>Select Patient</label>
                    <span class="text-danger">*</span>
                    <input type="text" id="edit_patient">
                    <!-- <select class="select2 patient" name="" id="edit_patient" style="width:100%;" required disabled>
                      <?php
                      if (isset($_GET['id'])) {
                        echo $id = $_GET['id'];
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="col-md-12 mt-4">
                  <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="all-tab" data-toggle="tab" data-target="#all" role="tab"
                        aria-controls="all" aria-selected="true">All</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="confirmed-tab" data-toggle="tab" data-target="#confirmed" role="tab"
                        aria-controls="confirmed" aria-selected="false">Confirmed</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="treated-tab" data-toggle="tab" data-target="#treated" role="tab"
                        aria-controls="treated-tab" aria-selected="false">Treated</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="cancelled-tab" data-toggle="tab" data-target="#cancelled" role="tab"
                        aria-controls="cancelled-tab" aria-selected="false">Cancelled</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="reschedule-tab" data-toggle="tab" data-target="#reschedule"
                        aria-controls="reschedule-tab" aria-selected="false">Reschedule</a>
                    </li>
                  </ul>
                </div>
                <div class="card-body">
