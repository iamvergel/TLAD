...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2025 at 10:11 AM
...
CREATE TRIGGER `after_employee_insert` AFTER INSERT ON `tblemployee` FOR EACH ROW BEGIN
    INSERT INTO `tblemployeeseminar` (`EmployeeNumber`, `Date`, `CertificateImage`, `Remarks`)
    VALUES (NEW.EmployeeNumber, NOW(), '', 0);
END
$$
DELIMITER ;
...
INSERT INTO `tblemployeeseminar` (`id`, `EmployeeNumber`, `Date`, `CertificateImage`, `Remarks`) VALUES
(1, '123123', '2025-01-30', NULL, 0),
(2, 'E123', '2025-01-30', NULL, 0),
(3, '111111', '2025-02-05', '', 0);
