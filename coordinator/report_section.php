...
<script>
  ...
  function filterTable() {
    ...
    xhr.open("GET", "filter_remarks_data.php?year=" + year + "&remarks=" + remarks, true);
      ...
      fetch('getCoordinatorInfo.php', {
        ...
        .then(data => {
          if (data.error) {
            ...
            document.getElementById('division-head-name').textContent = data.division_head_name;
            document.getElementById('unit-section-head-name').textContent = data.unit_section_head_name;
          }
        })
        .catch(error => {
            ...
            customize: function (doc) {
              ...
              if (coordinatorData) {
                doc.content.splice(1, 0, {
                  text:  'Division : ' + coordinatorData.department_name + '\n\n' + 'unit / Section : ' + coordinatorData.unit_name + '\n' + ' ',
                  marginTop: 5,
                  fontSize: 12,
                  alignment: 'left'
                });
          ...
          },
          {
            ...
            action: function (e, dt, button, config) {
              if (coordinatorData) {
                ...
                config.messageTop = `<div class="d-flex justify-content-center align-items-center mb-5"><img src="../admin/assets/image/header.jpg" alt="Header Image" style="width: 100%;"/></div>
                <div> Division : <strong>${coordinatorData.department_name}</strong> <br/><br/> Unit / Section : <strong>${coordinatorData.unit_name}</strong> <br/> </div>`

                config.messageBottom = `
                <div style="text-align: start;">
                    <p>Date: ${currentDate}</p>
                    <p>Prepared by:</p>
                    <label style="width: 30%; text-align:center">${coordinatorData.coordinator_name}</label>
                    <p style="border-top: 1px solid #000; width: 30%; text-align:center">Learning and Development Coordinator</p>
                    <p>Noted by: </p>
                    <label style="width: 30%; text-align:center">${coordinatorData.unit_section_head_name}</label>
                    <p style="border-top: 1px solid #000; width: 30%; text-align:center;">Unit/Section Head</p>
                    <p>Approved by: </p>
                    <label style="width: 30%; text-align:center">${coordinatorData.division_head_name}</label>
                    <p style="border-top: 1px solid #000; width: 30%; text-align:center; margin-bottom: 5rem;">Division Head</p>
                    <hr>
