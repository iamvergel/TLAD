            ...
            action: function (e, dt, button, config) {
              if (coordinatorData) {
                ...
                <div style="text-align: start;">
                    ...
                    <p>Prepared by:</p>
                    <label style="width: 30%; text-align:center">${coordinatorData.admin_name}</label>
                    <p style="border-top: 1px solid #000; width: 30%; text-align:center">Learning and Development Coordinator</p>
                    <p>Noted by: </p>
                    <label style="width: 30%; text-align:center">${coordinatorData.address}</label>
