...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2025 at 07:27 AM
...
(1, 'DJNRMHS - TLAD', '1,2,3,4,5,6,7', '8:00 AM', '6:00 PM', 'System Address', '+639952350999', 'feliztoothdev@gmail.com', '+639952350999', 'https://www.facebook.com', 'https://goo.gl/maps/AJx8wi8tU4TNuNh16', '1736819329.png', '1736819329.png');
...
INSERT INTO `tblcoordinator` (`id`, `name`, `dob`, `address`, `gender`, `phone`, `email`, `image`, `password`, `role`, `status`, `verify_token`, `verify_status`, `created_at`, `division_id`, `unit_id`, `coordinator_name`, `contact_number`, `email_address`, `unit_section_head_name`, `unit_section_head_title`, `division_head_name`, `division_head_position`) VALUES
(1, 'John Doe', '1990-05-15', '123 Main St, City, Country', 'Male', '123-456-7890', 'john.doe@example.com', '1678435022.png', 'hashed_password_1', 'staff', 1, 'random_verify_token_1', 0, '2025-01-14 13:57:38', 1, 1, 'Jane Smith', '098-765-4321', 'jane.smith@example.com', 'Mark Johnson', 'Manager', 'Alice Brown', 'Division Head'),
(2, 'Alice Green', '1985-11-25', '456 Oak St, City, Country', 'Female', '987-654-3210', 'alice.green@example.com', 'alice_green.jpg', 'hashed_password_2', 'staff', 1, 'random_verify_token_2', 0, '2025-01-14 13:57:38', 2, 2, 'Tom White', '555-1234', 'tom.white@example.com', 'Lucy Black', 'Supervisor', 'David Gray', 'Director'),
(3, 'Bob Blue', '1978-02-10', '789 Pine St, City, Country', 'Male', '555-555-5555', 'bob.blue@example.com', 'bob_blue.jpg', 'hashed_password_3', 'staff', 1, 'random_verify_token_3', 0, '2025-01-14 13:57:38', 3, 3, 'Sarah Red', '333-333-3333', 'sarah.red@example.com', 'Emma Yellow', 'Team Lead', 'Charles Purple', 'Executive Director');
